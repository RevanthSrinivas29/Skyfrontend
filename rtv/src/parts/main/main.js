...
import { Loadin } from '../loader/loadin';
...
export const Main = () => {
  ...
  const handleSubmitRating = async () => {
    try {
      setSubmitted(true); 
      await axios.post('https://skybackend.onrender.com/', { id: 1, rating });
        toast({
  ...
  if (loading) {
    // Display the custom loading spinner
    return (
      <Center height="100vh">
        <Loadin /> {/* This is your customized spinner */}
      </Center>
    );
  }
    ...
    <Box>
        ...
        <HStack spacing={4}>
          <Menu>
            ...
            <MenuList bg="#000000" color="white">
              ...
              <MenuItem bg="#000000" color="white" _hover={{ bg: '#3C3D37' }} onClick={() => navigate('/customer-care')}>
      ...
      >
        <Heading fontSize="4xl" color="#4b0082" m={4}>
          ...
          Box cricket is a lively and social variant of traditional cricket, played in smaller, enclosed spaces like courtyards or parks with teams of 5 to 10 players.Whether you're a seasoned player or just looking for fun with friends, our enclosed pitch offers the perfect venue for a thrilling game of cricket, rain or shine.
        </Text>
      ...
      >
        <Heading fontSize="4xl" color="#4b0082" m={4}>
           SwimmingPool
            ...
            <Text textAlign="center" m={4}>
            Our swimming pool offers the ultimate relaxation experience, with crystal-clear water perfectly adjusted to the current atmosphere. Whether you're looking for a leisurely swim or a fitness routine, our pool caters to both with ease. It provides the perfect backdrop for your experience, allowing you to enjoy the perfect balance of relaxation and fitness        </Text>
        <Text textAlign="left" fontSize='lg' m={9}>
          <strong>Key Features:</strong>
          <br/>
          <li>Spacious pool deck with comfortable chairs and open areas.</li>
          <li> Safety swimming tubes provided for kids.</li>
          <li> Safety first with lifeguards on duty at all times.</li>
          <li>  Temperature-controlled water, customized to your preferred temperature.</li>
      ...
      >
        <Heading fontSize="4xl" color="#4b0082" m={4}>
           Party House
            ...
            <Text textAlign="center" m={4}>
            The Perfect venue for your next celebration! Our party house is designed to make every event memorable, offering a stylish and versatile space for gatherings of all sizes. Whether it's a birthday bash, wedding reception, or any special occasion, our party house provides the ideal backdrop for your event to shine.        </Text>
        <Text textAlign="left" fontSize='lg' m={9}>
          <strong>Key Features:</strong>
          <br />
         <li> Clean and spacious rooms with en-suite bathrooms</li>
         <li>Comfortable beds and fresh linens</li>
         <li>Complimentary Wi-Fi</li>
         <li> 24/7 reception and room service</li>
         <li> Secure parking and luggage storage </li>
         <li>Spacious indoor and outdoor areas, perfect for mingling, dancing, and entertainment.</li>
          <br />
        </Text>
      </Box>
...
{/* fileuploading */}
        ...
        {/* <Heading>Would you like to add your memories here</Heading>
        <Button
         mt={4}
         colorScheme="teal"
         onClick={()=>navigate('/fileupload')}>Click here</Button> */}
      {/* Footer */}
